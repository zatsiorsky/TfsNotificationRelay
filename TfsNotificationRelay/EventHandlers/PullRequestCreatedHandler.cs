...
namespace DevCore.TfsNotificationRelay.EventHandlers
{
    ...
    {
        protected override Notifications.INotification CreateNotification(TeamFoundationRequestContext requestContext, PullRequestCreatedNotification ev, int maxLines)
        {
